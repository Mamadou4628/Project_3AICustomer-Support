...
const systemPrompt = `You are an AI-powered customer support assistant for HeadStartAI, a platform that provides AI-driven interviews for softwar
...
6.    Always maintain user privacy and do not share personal information.If you're unsure about any information, it's okay to say you don't know and offer to connect the user with a human representative.
...
export async function POST(req){
    ...
    const completion = await OpenAI.Chat.Completions.creat({
        messages:[{
